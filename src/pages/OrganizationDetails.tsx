...
const OrganizationDetails: React.FC = () => {
    ...
    // FIX: Replaced Mantine RingProgress with an identical, pure native SVG component.
    // Radius 27 + strokeWidth 6 = 30, safely inside 70/2=35 center.
