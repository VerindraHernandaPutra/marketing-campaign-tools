  ...
  return (
    ...
    >
      ...
      <Box style={{
        ...
        width: '450px', height: '450px', borderRadius: '50%',
        background: 'rgba(139, 92, 246, 0.18)', filter: 'blur(80px)',
        pointerEvents: 'none',
      }} />
      <Box style={{
        position: 'absolute', top: '40%', left: '30%',
        width: '300px', height: '300px', borderRadius: '50%',
        background: 'rgba(79, 70, 229, 0.08)', filter: 'blur(60px)',
        pointerEvents: 'none',
      }} />
      ...
      >
        ...
        <Divider
          ...
          label={
            <Text size="xs" c="dimmed" fw={500}>Sign in to your account</Text>
          }
        />
