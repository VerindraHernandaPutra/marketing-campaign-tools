...
import MetaSocialPerformance from '../components/Analytics/MetaSocialPerformance';
...
const Analytics: React.FC = () => {
  ...
  const handleGenerateSummary = async () => {
    ...
    try {
      ...
      alert('Failed to generate analysis. Check that OPENAI_API_KEY is set in your Supabase secrets and the function is deployed.');
    } finally {
