      ...
      <Stack align="center" gap="md" py="xl">
        ...
        <Box
          style={{
            ...
            height: 88,
            borderRadius: '50%',
            background: result.type === 'error' ? '#fff5f5' : result.type === 'sent' ? '#f0fff4' : result.type === 'scheduled' ? '#e7f5ff' : '#f8f9fa',
          }}
        >
          {cfg.icon}
        </Box>
        ...
        {result.type === 'error' && result.errorMessage && (
          <Box
            w="100%"
            p="md"
            style={{ background: '#fff5f5', borderRadius: 10, border: '1px solid #ffc9c9' }}
          >
