...
const ROLE_CONFIG = {
  ...
  admin: {
    ...
    tagline: 'Platform-wide administrator. Manage all organizations and users.',
    capabilities: [
    ...
    quickStats: [
      ...
      { label: 'Scope', value: 'Platform-wide', color: '#ef4444' },
    ...
    <Box p="xl" style={{ maxWidth: 960, margin: '0 auto' }}>
      ...
      <Group align="flex-start" justify="space-between" mb="xl">
        <Box>
          ...
          <Title order={2} fw={600} style={{ letterSpacing: '-0.01em' }}>
            {displayName}
          </Title>
        ...
        >
          ...
          <Box>
            ...
            <Text size="sm" fw={600} style={{ color: config.color, lineHeight: 1.3 }}>
              {config.label}
            </Text>
          </Box>
        </Box>
      ...
      <SimpleGrid cols={2} spacing="lg">
                ...
                <Group gap={8} wrap="nowrap">
                  ...
                  <Box style={{ flex: 1 }}>
                    <Text
                      size="xs"
                      fw={500}
                      style={{ color: cap.available ? '#111827' : '#9ca3af' }}
                    >
                      {cap.label}
                    </Text>
        ...
        <Box>
            ...
            <Timeline active={-1} bulletSize={20} lineWidth={1} color={config.color}>
              {config.gettingStarted.map((step, i) => (
                <Timeline.Item
                  key={i}
                  bullet={
                    <Text size="xs" fw={600} style={{ color: config.color }}>
                      {i + 1}
                    </Text>
                  }
                >
          ...
          <Paper p="md" radius="md" withBorder style={{ borderColor: '#e5e7eb' }}>
            <Group gap={10}>
              <Avatar size={36} radius="xl" color={config.color.replace('#', '')} style={{ background: config.bg }}>
              ...
              <Badge
                size="xs"
                style={{ background: config.color + '18', color: config.color, border: 'none', fontWeight: 500 }}
              >
                {config.label}
              </Badge>
            </Group>
