    ...
    for (const platform of platformList) {
      try {
        if (platform === 'facebook') {
          ...
          results.facebook = await postFacebookPage(integration.provider_account_id, integration.access_token, content, media_urls || []);
          ...
          results.instagram = await postInstagramBusiness(integration.provider_account_id, integration.access_token, content, media_urls || []);
        } else {
